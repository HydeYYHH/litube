...
public final class MediaMuxerImpl implements MediaMuxer {

	@Override
	public void merge(@NonNull final File videoFile, @NonNull final File audioFile, @NonNull final File outputFile) throws IOException {
	...
	public static final class EmptyTrackException extends RuntimeException {
