...
public final class ControllerState {
	...
	public record UiState(
                    ...
                    boolean miniCloseRestoreVisible,
	...
	public ControllerState withControlsVisible(final boolean visible) {
		if (controlsVisible == visible) return this;
		return new ControllerState(mode, previousModeBeforePip, previousModeBeforeMiniPlayer, visible);
	}
	...
	public ControllerState enterPip() {
		...
		return new ControllerState(Mode.PIP, mode, previousModeBeforeMiniPlayer, true);
	}
	...
	public UiState toUiState(final boolean isBuffering, final boolean isZoomed) {
		...
		return new UiState(
						...
						controlsVisible && (isInMiniPlayer() || isInPictureInPicture()),
						controlsVisible && (isInMiniPlayer() || isInPictureInPicture()),
