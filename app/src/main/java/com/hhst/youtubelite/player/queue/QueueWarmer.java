...
public final class QueueWarmer {
	...
	private WarmRequest createRequest(@Nullable final String url) {
		...
		final String videoId = normalize(YoutubeExtractor.getVideoId(normalizedUrl));
		return videoId != null ? new WarmRequest(videoId, normalizedUrl) : null;
	}

	@Nullable
	private String resolveVideoId(@NonNull final QueueItem item, @NonNull final String url) {
